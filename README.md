...
Este documento proporciona información sobre FadSDK, el SDK web que permite a los desarrolladores integrar funcionalidad de diferentes módulos (link al apartado e módulos) en sus aplicaciones web móviles.
